...
class Face{
    public:
        ...
        bool             behind( Vertex *p);
        bool             conflict( Vertex* p); 
        HullEdge*        getEdge(int i);
    ...
    private:
        ...
        ConflictList*   list_;
        bool            marked_;
        Vertex*         v1_;//These points are pointers that generated by convexhull, and their memory allocated were managed by convexhull
        Vertex*         v2_;//These points are pointers that generated by convexhull, and their memory allocated were managed by convexhull
        Vertex*         v0_;//These points are pointers that generated by convexhull, and their memory allocated were managed by convexhull
        HullEdge*       e1_;
        HullEdge*       e2_;
        HullEdge*       e0_;
        Vector*         normal_;
